...
double a_penny_doubled_everyday(int days, double value) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
	...
	if (days <= 1)
		return value;
	return (a_penny_doubled_everyday(days - 1, value * 2.0));
